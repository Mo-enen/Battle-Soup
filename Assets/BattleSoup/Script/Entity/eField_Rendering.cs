	...
	public partial class eField {
		...
		public void DrawCannonBall (int localX, int localY, float t01) {
			...
			if (t01 < 0.5f) {
				...
				CellRenderer.Draw(
					CANNON_CODE,
					x + (int)Mathf.LerpUnclamped(SoupConst.ISO_SIZE * 2, 0, 1f - (1f - t01) * (1f - t01)) + SoupConst.ISO_SIZE / 2,
					y + (int)Mathf.LerpUnclamped(SoupConst.ISO_SIZE * 8, SoupConst.ISO_SIZE, t01 * t01),
					500, 500, (int)(t01 * 1200),
					SoupConst.ISO_SIZE, SoupConst.ISO_SIZE
				);
			}
