...
namespace BattleSoup {
	public class sUnreveal : sSoupStep {
		...
		public override StepResult FrameUpdate (Game game) {
			...
			if (UseAnimation && LocalFrame < DURATION) {
				if (LocalFrame % 4 < 2) {
					...
					CellRenderer.Draw(
						FRAME_CODE,
						x, y + (int)((1f - t01) * SoupConst.ISO_SIZE / 2),
						SoupConst.ISO_SIZE, SoupConst.ISO_SIZE,
						new Color32(255, 255, 255, (byte)Util.Remap(1f, 0f, 255, 0, t01))
					);
				}
