namespace Moenen.Standard {
	...
	public class SavingVector2Int : Saving<Vector2Int> {

		public SavingVector2Int (string key, Vector2Int defaultValue) : base(key, defaultValue) { }
		...
		public static implicit operator Vector2Int (SavingVector2Int value) {
			return value.Value;
		}
		protected override void DeleteKey () {
