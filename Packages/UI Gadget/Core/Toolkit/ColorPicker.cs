namespace UIGadget {
	...
	public class ColorPicker : Image, IPointerDownHandler, IDragHandler {
		...
		// VAR
		[Header("Picker")]
		[Range(0f, 1f), SerializeField] float m_H = 0f;
		[Range(0f, 1f), SerializeField] float m_S = 1f;
		[Range(0f, 1f), SerializeField] float m_V = 1f;
		[Range(0f, 1f), SerializeField] float m_A = 1f;
		[SerializeField] PickerMode m_Mode = PickerMode.HSV;
		[Header("UI")]
		[SerializeField] bool m_UseAlpha = true;
		[SerializeField] float m_ThumbnailWidthAmonut = 1f;
		[SerializeField] float m_InnerGap = 0f;
		[SerializeField] float m_HandleWidth = 12f;
		[SerializeField] float m_HandleOutlineSize = 6f;
		[SerializeField] Color m_Background = new Color(0.86f, 0.86f, 0.86f, 1f);
		[SerializeField] Color m_Handle = Color.white;
		[SerializeField] Color m_HandleOutline = Color.black;
		[SerializeField] RectOffset m_Padding = default;

		[Space]
		[SerializeField] SetColorEvent m_OnColorEdit = null;
