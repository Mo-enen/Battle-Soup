namespace UIGadget {
	...
	public class TimeBomb : MonoBehaviour {
		...
		// Ser
		[SerializeField] bool m_LitOnStart = true;
		[SerializeField] bool m_DestroyOnBlowUp = true;
		[SerializeField] bool m_BlowUpOnDestroy = false;
		[SerializeField] float m_Duration = 1f;
		[SerializeField] BlowUpEvent m_OnBlowUp = null;
