namespace UIGadget {
	...
	[AddComponentMenu("UIGadget/TriggerCollider")]
	public class TriggerCollider : MonoBehaviour {
		...
		// Ser
		[SerializeField] Transform m_Highlight = null;
		[SerializeField] LayerMask m_AxisMask = 0;
		[Space]
		[SerializeField] UnityEvent m_CallbackLeft = null;
		[SerializeField] UnityEvent m_CallbackDrag = null;
