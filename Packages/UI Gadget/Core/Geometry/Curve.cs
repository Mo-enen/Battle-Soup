namespace UIGadget {
	...
	public class Curve : Image {
		...
		[SerializeField] Color m_LineColor = Color.white;
		[SerializeField] int m_LineDetail = 16;
		[SerializeField] int m_CornerDetail = 16;
		[SerializeField] float m_CurveSize = 4f;
		[SerializeField] float m_DotSize = 8f;
