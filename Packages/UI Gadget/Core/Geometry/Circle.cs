namespace UIGadget {
	...
	public class Circle : Image {
		...
		// Ser
		[Header("Circle"), SerializeField] AdaptMode m_Adapt = AdaptMode.FitIn;
		[SerializeField] int m_Detail = 48;
		[SerializeField] float m_StartAngle = 0f;
		[SerializeField] float m_EndAngle = 360f;
		[Range(0f, 1f), SerializeField] float m_RingOffset = 0f;
		[SerializeField] Color m_FillColor = Color.white;
		[Header("Border"), SerializeField] float m_Border = 4f;
		[Range(0f, 1f), SerializeField] float m_BorderOffset = 0.5f;
