namespace UIGadget {
	...
	[AddComponentMenu("UIGadget/VectorGrid")]
	public class VectorGrid : Image {
		...
		// Ser
		[SerializeField] int m_X = 8;
		[SerializeField] int m_Y = 8;
		[SerializeField] float m_Size = 2f;
		[SerializeField] bool m_Soft = true;
		[SerializeField] bool m_Corner = true;
