namespace UIGadget {
	...
	public class Triangle : Image {
		...
		// Ser
		[Header("Triangle")]
		[SerializeField] Vector2 m_A = new Vector2(0f, 0f);
		[SerializeField] Vector2 m_B = new Vector2(1f, 0f);
		[SerializeField] Vector2 m_C = new Vector2(0.5f, 1f);
		[SerializeField] int m_Detail = 48;
		[SerializeField] float m_Round = 8;
